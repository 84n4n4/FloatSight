...
import static com.watchthybridle.floatsight.mpandroidchart.linedatasetcreation.ChartDataSetProperties.GLIDE_FORMAT;
...
public final class PlotFragmentDialogs {
    ...
    public static void showGlideCapDialog(PlotFragment plotFragment, CappedTrackPointValueProvider cappedTrackPointValueProvider) {
        ...
        seekBarTextView.setText(GLIDE_FORMAT.format(cappedTrackPointValueProvider.getCapYValueAt()));
